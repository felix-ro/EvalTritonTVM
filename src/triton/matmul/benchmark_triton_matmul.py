...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        line_vals=['cublas', 'triton-tuned-default', 'triton-tuned-advanced', 'triton-untuned'],
        # Label name for the lines
        line_names=["cuBLAS", "Triton default Tuning", "Triton advanced Tuning", "Triton No Tuning"],
        # Line styles
        styles=[('green', '-'), ('blue', '-'), ('orange', '-'), ('grey', '-')],
